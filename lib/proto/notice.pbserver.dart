...
abstract class noticeServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$8.GetUserNoticeDataResp> getUserNoticeData($pb.ServerContext ctx, $8.GetUserNoticeDataReq request);
  $async.Future<$8.AckNoticeDataResp> ackNoticeData($pb.ServerContext ctx, $8.AckNoticeDataReq request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      ...
      case 'GetUserNoticeData': return $8.GetUserNoticeDataReq();
      case 'AckNoticeData': return $8.AckNoticeDataReq();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      ...
      case 'GetUserNoticeData': return this.getUserNoticeData(ctx, request as $8.GetUserNoticeDataReq);
      case 'AckNoticeData': return this.ackNoticeData(ctx, request as $8.AckNoticeDataReq);
      default: throw $core.ArgumentError('Unknown method: $method');
    }
  }
