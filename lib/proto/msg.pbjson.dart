...
const BatchGetMsgListByConvIdReq$json = const {
  ...
  '2': const [
    ...
    const {'1': 'return', '3': 2, '4': 1, '5': 8, '10': 'return'},
    const {'1': 'commonReq', '3': 11, '4': 1, '5': 11, '6': '.pb.CommonReq', '10': 'commonReq'},
  ],
...
final $typed_data.Uint8List batchGetMsgListByConvIdReqDescriptor = $convert.base64Decode('');
...
const GetMsgByIdReq$json = const {
  ...
  '2': const [
    ...
    const {'1': 'return', '3': 3, '4': 1, '5': 8, '10': 'return'},
    const {'1': 'commonReq', '3': 11, '4': 1, '5': 11, '6': '.pb.CommonReq', '10': 'commonReq'},
  ],
  '8': const [
...
final $typed_data.Uint8List getMsgByIdReqDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgServiceDescriptor = $convert.base64Decode('');
