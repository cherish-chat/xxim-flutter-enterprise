...
const $core.Map<$core.String, $core.dynamic> appMgmtServiceBase$json = const {
  ...
  '2': const [
    ...
    const {'1': 'GetAllAppMgmtRichArticle', '2': '.pb.GetAllAppMgmtRichArticleReq', '3': '.pb.GetAllAppMgmtRichArticleResp'},
    const {'1': 'GetAppMgmtRichArticleDetail', '2': '.pb.GetAppMgmtRichArticleDetailReq', '3': '.pb.GetAppMgmtRichArticleDetailResp'},
    const {'1': 'AddAppMgmtRichArticle', '2': '.pb.AddAppMgmtRichArticleReq', '3': '.pb.AddAppMgmtRichArticleResp'},
    const {'1': 'UpdateAppMgmtRichArticle', '2': '.pb.UpdateAppMgmtRichArticleReq', '3': '.pb.UpdateAppMgmtRichArticleResp'},
    const {'1': 'DeleteAppMgmtRichArticle', '2': '.pb.DeleteAppMgmtRichArticleReq', '3': '.pb.DeleteAppMgmtRichArticleResp'},
    const {'1': 'AppGetRichArticleList', '2': '.pb.AppGetRichArticleListReq', '3': '.pb.AppGetRichArticleListResp'},
    const {'1': 'UpdateAppAddressBook', '2': '.pb.UpdateAppAddressBookReq', '3': '.pb.UpdateAppAddressBookResp'},
    const {'1': 'GetAppAddressBook', '2': '.pb.GetAppAddressBookReq', '3': '.pb.GetAppAddressBookResp'},
    const {'1': 'GetAppAddressBookUrl', '2': '.pb.GetAppAddressBookUrlReq', '3': '.pb.GetAppAddressBookUrlResp'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> appMgmtServiceBase$messageJson = const {
  ...
  '.pb.GetAllAppMgmtRichArticleReq': GetAllAppMgmtRichArticleReq$json,
  '.pb.GetAllAppMgmtRichArticleReq.FilterEntry': GetAllAppMgmtRichArticleReq_FilterEntry$json,
  '.pb.GetAllAppMgmtRichArticleResp': GetAllAppMgmtRichArticleResp$json,
  '.pb.AppMgmtRichArticle': AppMgmtRichArticle$json,
  '.pb.GetAppMgmtRichArticleDetailReq': GetAppMgmtRichArticleDetailReq$json,
  '.pb.GetAppMgmtRichArticleDetailResp': GetAppMgmtRichArticleDetailResp$json,
  '.pb.AddAppMgmtRichArticleReq': AddAppMgmtRichArticleReq$json,
  '.pb.AddAppMgmtRichArticleResp': AddAppMgmtRichArticleResp$json,
  '.pb.UpdateAppMgmtRichArticleReq': UpdateAppMgmtRichArticleReq$json,
  '.pb.UpdateAppMgmtRichArticleResp': UpdateAppMgmtRichArticleResp$json,
  '.pb.DeleteAppMgmtRichArticleReq': DeleteAppMgmtRichArticleReq$json,
  '.pb.DeleteAppMgmtRichArticleResp': DeleteAppMgmtRichArticleResp$json,
  '.pb.AppGetRichArticleListReq': AppGetRichArticleListReq$json,
  '.pb.AppGetRichArticleListResp': AppGetRichArticleListResp$json,
  '.pb.UpdateAppAddressBookReq': UpdateAppAddressBookReq$json,
  '.pb.UpdateAppAddressBookResp': UpdateAppAddressBookResp$json,
  '.pb.GetAppAddressBookReq': GetAppAddressBookReq$json,
  '.pb.GetAppAddressBookResp': GetAppAddressBookResp$json,
  '.pb.GetAppAddressBookUrlReq': GetAppAddressBookUrlReq$json,
  '.pb.GetAppAddressBookUrlResp': GetAppAddressBookUrlResp$json,
};

/// Descriptor for `appMgmtService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List appMgmtServiceDescriptor = $convert.base64Decode('');
