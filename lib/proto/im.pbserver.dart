...
abstract class imServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$2.GetAppSystemConfigResp> getAppSystemConfig($pb.ServerContext ctx, $2.GetAppSystemConfigReq request);
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      ...
      case 'GetAppSystemConfig': return $2.GetAppSystemConfigReq();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      ...
      case 'GetAppSystemConfig': return this.getAppSystemConfig(ctx, request as $2.GetAppSystemConfigReq);
