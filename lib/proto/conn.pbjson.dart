...
final $typed_data.Uint8List pushEventDescriptor = $convert.base64Decode('CglQdXNoRXZlbnQSEwoPUHVzaE1zZ0RhdGFMaXN0EAASEgoOUHVzaE5vdGljZURhdGEQARIUChBQdXNoUmVzcG9uc2VCb2R5EAISFAoQUHVzaEFmdGVyQ29ubmVjdBAD');
...
const ConnParam$json = const {
  ...
  '2': const [
    ...
    const {'1': 'aesKey', '3': 14, '4': 1, '5': 9, '9': 0, '10': 'aesKey', '17': true},
    const {'1': 'aesIv', '3': 15, '4': 1, '5': 9, '9': 1, '10': 'aesIv', '17': true},
  ],
...
final $typed_data.Uint8List connParamDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List afterConnectBodyDescriptor = $convert.base64Decode('ChBBZnRlckNvbm5lY3RCb2R5EhQKBWFlc0l2GAEgASgJUgVhZXNJdg==');
...
final $typed_data.Uint8List setCxnParamsReqDescriptor = $convert.base64Decode('');
...
const SetCxnParamsResp$json = const {
  ...
  '2': const [
    ...
    const {'1': 'aesKey', '3': 8, '4': 1, '5': 12, '9': 0, '10': 'aesKey', '17': true},
    const {'1': 'aesIv', '3': 9, '4': 1, '5': 12, '9': 1, '10': 'aesIv', '17': true},
    const {'1': 'ext', '3': 11, '4': 1, '5': 12, '10': 'ext'},
  ],
  '8': const [
    const {'1': '_aesKey'},
...
final $typed_data.Uint8List setCxnParamsRespDescriptor = $convert.base64Decode('');
