...
const $core.Map<$core.String, $core.dynamic> mgmtServiceBase$json = const {
  '1': 'mgmtService',
  '2': const [
    const {'1': 'AfterConnect', '2': '.pb.AfterConnectReq', '3': '.pb.CommonResp'},
    const {'1': 'AfterDisconnect', '2': '.pb.AfterDisconnectReq', '3': '.pb.CommonResp'},
    const {'1': 'GetServerConfig', '2': '.pb.GetServerConfigReq', '3': '.pb.GetServerConfigResp'},
    const {'1': 'GetServerAllConfig', '2': '.pb.GetServerAllConfigReq', '3': '.pb.GetServerAllConfigResp'},
    const {'1': 'UpdateServerConfig', '2': '.pb.UpdateServerConfigReq', '3': '.pb.UpdateServerConfigResp'},
    const {'1': 'GetAppLineConfig', '2': '.pb.GetAppLineConfigReq', '3': '.pb.GetAppLineConfigResp'},
    const {'1': 'UpdateAppLineConfig', '2': '.pb.UpdateAppLineConfigReq', '3': '.pb.UpdateAppLineConfigResp'},
    const {'1': 'LoginMSCaptcha', '2': '.pb.LoginMSCaptchaReq', '3': '.pb.LoginMSCaptchaResp'},
    const {'1': 'VerifyLoginMSCaptchaCode', '2': '.pb.VerifyLoginMSCaptchaCodeReq', '3': '.pb.VerifyLoginMSCaptchaCodeResp'},
    const {'1': 'LoginMS', '2': '.pb.LoginMSReq', '3': '.pb.LoginMSResp'},
    const {'1': 'HealthMS', '2': '.pb.CommonReq', '3': '.pb.HealthMSResp'},
    const {'1': 'ConfigMS', '2': '.pb.CommonReq', '3': '.pb.ConfigMSResp'},
    const {'1': 'GetAllMSMenuList', '2': '.pb.GetAllMSMenuListReq', '3': '.pb.GetAllMSMenuListResp'},
    const {'1': 'GetMyMSMenuList', '2': '.pb.GetMyMSMenuListReq', '3': '.pb.GetMyMSMenuListResp'},
    const {'1': 'GetMSMenuDetail', '2': '.pb.GetMSMenuDetailReq', '3': '.pb.GetMSMenuDetailResp'},
    const {'1': 'AddMSMenu', '2': '.pb.AddMSMenuReq', '3': '.pb.AddMSMenuResp'},
    const {'1': 'UpdateMSMenu', '2': '.pb.UpdateMSMenuReq', '3': '.pb.UpdateMSMenuResp'},
    const {'1': 'DeleteMSMenu', '2': '.pb.DeleteMSMenuReq', '3': '.pb.DeleteMSMenuResp'},
    const {'1': 'GetAllMSApiPathList', '2': '.pb.GetAllMSApiPathListReq', '3': '.pb.GetAllMSApiPathListResp'},
    const {'1': 'GetMyMSApiPathList', '2': '.pb.GetMyMSApiPathListReq', '3': '.pb.GetMyMSApiPathListResp'},
    const {'1': 'GetMSApiPathDetail', '2': '.pb.GetMSApiPathDetailReq', '3': '.pb.GetMSApiPathDetailResp'},
    const {'1': 'AddMSApiPath', '2': '.pb.AddMSApiPathReq', '3': '.pb.AddMSApiPathResp'},
    const {'1': 'UpdateMSApiPath', '2': '.pb.UpdateMSApiPathReq', '3': '.pb.UpdateMSApiPathResp'},
    const {'1': 'DeleteMSApiPath', '2': '.pb.DeleteMSApiPathReq', '3': '.pb.DeleteMSApiPathResp'},
    const {'1': 'GetAllMSRoleList', '2': '.pb.GetAllMSRoleListReq', '3': '.pb.GetAllMSRoleListResp'},
    const {'1': 'GetMSRoleDetail', '2': '.pb.GetMSRoleDetailReq', '3': '.pb.GetMSRoleDetailResp'},
    const {'1': 'AddMSRole', '2': '.pb.AddMSRoleReq', '3': '.pb.AddMSRoleResp'},
    const {'1': 'UpdateMSRole', '2': '.pb.UpdateMSRoleReq', '3': '.pb.UpdateMSRoleResp'},
    const {'1': 'DeleteMSRole', '2': '.pb.DeleteMSRoleReq', '3': '.pb.DeleteMSRoleResp'},
    const {'1': 'GetAllMSUserList', '2': '.pb.GetAllMSUserListReq', '3': '.pb.GetAllMSUserListResp'},
    const {'1': 'GetMSUserDetail', '2': '.pb.GetMSUserDetailReq', '3': '.pb.GetMSUserDetailResp'},
    const {'1': 'GetSelfMSUserDetail', '2': '.pb.GetSelfMSUserDetailReq', '3': '.pb.GetSelfMSUserDetailResp'},
    const {'1': 'AddMSUser', '2': '.pb.AddMSUserReq', '3': '.pb.AddMSUserResp'},
    const {'1': 'UpdateMSUser', '2': '.pb.UpdateMSUserReq', '3': '.pb.UpdateMSUserResp'},
    const {'1': 'DeleteMSUser', '2': '.pb.DeleteMSUserReq', '3': '.pb.DeleteMSUserResp'},
    const {'1': 'SwitchMSUserStatus', '2': '.pb.SwitchMSUserStatusReq', '3': '.pb.SwitchMSUserStatusResp'},
    const {'1': 'GetAllMSIpWhiteList', '2': '.pb.GetAllMSIpWhiteListReq', '3': '.pb.GetAllMSIpWhiteListResp'},
    const {'1': 'GetMSIpWhiteListDetail', '2': '.pb.GetMSIpWhiteListDetailReq', '3': '.pb.GetMSIpWhiteListDetailResp'},
    const {'1': 'AddMSIpWhiteList', '2': '.pb.AddMSIpWhiteListReq', '3': '.pb.AddMSIpWhiteListResp'},
    const {'1': 'UpdateMSIpWhiteList', '2': '.pb.UpdateMSIpWhiteListReq', '3': '.pb.UpdateMSIpWhiteListResp'},
    const {'1': 'DeleteMSIpWhiteList', '2': '.pb.DeleteMSIpWhiteListReq', '3': '.pb.DeleteMSIpWhiteListResp'},
    const {'1': 'GetAllMSLuaConfig', '2': '.pb.GetAllMSLuaConfigReq', '3': '.pb.GetAllMSLuaConfigResp'},
    const {'1': 'GetMSLuaConfigDetail', '2': '.pb.GetMSLuaConfigReq', '3': '.pb.GetMSLuaConfigResp'},
    const {'1': 'AddMSLuaConfig', '2': '.pb.AddMSLuaConfigReq', '3': '.pb.AddMSLuaConfigResp'},
    const {'1': 'UpdateMSLuaConfig', '2': '.pb.UpdateMSLuaConfigReq', '3': '.pb.UpdateMSLuaConfigResp'},
    const {'1': 'DeleteMSLuaConfig', '2': '.pb.DeleteMSLuaConfigReq', '3': '.pb.DeleteMSLuaConfigResp'},
    const {'1': 'GetAllMSOperationLog', '2': '.pb.GetAllMSOperationLogReq', '3': '.pb.GetAllMSOperationLogResp'},
    const {'1': 'GetMSOperationLogDetail', '2': '.pb.GetMSOperationLogDetailReq', '3': '.pb.GetMSOperationLogDetailResp'},
    const {'1': 'DeleteMSOperationLog', '2': '.pb.DeleteMSOperationLogReq', '3': '.pb.DeleteMSOperationLogResp'},
    const {'1': 'GetAllMSLoginRecord', '2': '.pb.GetAllMSLoginRecordReq', '3': '.pb.GetAllMSLoginRecordResp'},
    const {'1': 'GetAllMSAlbumCate', '2': '.pb.GetAllMSAlbumCateReq', '3': '.pb.GetAllMSAlbumCateResp'},
    const {'1': 'DeleteMSAlbumCate', '2': '.pb.DeleteMSAlbumCateReq', '3': '.pb.DeleteMSAlbumCateResp'},
    const {'1': 'AddMSAlbumCate', '2': '.pb.AddMSAlbumCateReq', '3': '.pb.AddMSAlbumCateResp'},
    const {'1': 'UpdateMSAlbumCate', '2': '.pb.UpdateMSAlbumCateReq', '3': '.pb.UpdateMSAlbumCateResp'},
    const {'1': 'GetAllMSAlbum', '2': '.pb.GetAllMSAlbumReq', '3': '.pb.GetAllMSAlbumResp'},
    const {'1': 'DeleteMSAlbum', '2': '.pb.DeleteMSAlbumReq', '3': '.pb.DeleteMSAlbumResp'},
    const {'1': 'UpdateMSAlbum', '2': '.pb.UpdateMSAlbumReq', '3': '.pb.UpdateMSAlbumResp'},
    const {'1': 'StatsMS', '2': '.pb.StatsMSReq', '3': '.pb.StatsMSResp'},
    const {'1': 'ClearAllUser', '2': '.pb.ClearAllUserReq', '3': '.pb.ClearAllUserResp'},
  ],
};

@$core.Deprecated('Use mgmtServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> mgmtServiceBase$messageJson = const {
  ...
  '.pb.GetServerConfigReq': GetServerConfigReq$json,
  '.pb.CommonReq': $0.CommonReq$json,
  '.pb.GetServerConfigResp': GetServerConfigResp$json,
  '.pb.GetServerAllConfigReq': GetServerAllConfigReq$json,
  '.pb.GetServerAllConfigResp': GetServerAllConfigResp$json,
  '.pb.GetServerAllConfigResp.CommonConfig': GetServerAllConfigResp_CommonConfig$json,
  '.pb.GetServerAllConfigResp.TelemetryConfig': GetServerAllConfigResp_TelemetryConfig$json,
  '.pb.GetServerAllConfigResp.RedisConfig': GetServerAllConfigResp_RedisConfig$json,
  '.pb.GetServerAllConfigResp.MysqlConfig': GetServerAllConfigResp_MysqlConfig$json,
  '.pb.GetServerAllConfigResp.ConnRpcConfig': GetServerAllConfigResp_ConnRpcConfig$json,
  '.pb.GetServerAllConfigResp.ImRpcConfig': GetServerAllConfigResp_ImRpcConfig$json,
  '.pb.GetServerAllConfigResp.MsgRpcConfig': GetServerAllConfigResp_MsgRpcConfig$json,
  '.pb.GetServerAllConfigResp.MobPushConfig': GetServerAllConfigResp_MobPushConfig$json,
  '.pb.GetServerAllConfigResp.MsgPulsarConfig': GetServerAllConfigResp_MsgPulsarConfig$json,
  '.pb.GetServerAllConfigResp.UserRpcConfig': GetServerAllConfigResp_UserRpcConfig$json,
  '.pb.GetServerAllConfigResp.SmsConfig': GetServerAllConfigResp_SmsConfig$json,
  '.pb.GetServerAllConfigResp.TencentSmsConfig': GetServerAllConfigResp_TencentSmsConfig$json,
  '.pb.GetServerAllConfigResp.RelationRpcConfig': GetServerAllConfigResp_RelationRpcConfig$json,
  '.pb.GetServerAllConfigResp.GroupRpcConfig': GetServerAllConfigResp_GroupRpcConfig$json,
  '.pb.GetServerAllConfigResp.NoticeRpcConfig': GetServerAllConfigResp_NoticeRpcConfig$json,
  '.pb.GetServerAllConfigResp.AppMgmtRpcConfig': GetServerAllConfigResp_AppMgmtRpcConfig$json,
  '.pb.GetServerAllConfigResp.MgmtConfig': GetServerAllConfigResp_MgmtConfig$json,
  '.pb.GetServerAllConfigResp.XosConfig': GetServerAllConfigResp_XosConfig$json,
  '.pb.UpdateServerConfigReq': UpdateServerConfigReq$json,
  '.pb.UpdateServerConfigResp': UpdateServerConfigResp$json,
  '.pb.GetAppLineConfigReq': GetAppLineConfigReq$json,
  '.pb.GetAppLineConfigResp': GetAppLineConfigResp$json,
  '.pb.AppLineConfig': AppLineConfig$json,
  '.pb.AppLineConfig.Storage': AppLineConfig_Storage$json,
  '.pb.AppLineConfig.Storage.Cos': AppLineConfig_Storage_Cos$json,
  '.pb.AppLineConfig.Storage.Oss': AppLineConfig_Storage_Oss$json,
  '.pb.AppLineConfig.Storage.Minio': AppLineConfig_Storage_Minio$json,
  '.pb.AppLineConfig.Storage.Kodo': AppLineConfig_Storage_Kodo$json,
  '.pb.UpdateAppLineConfigReq': UpdateAppLineConfigReq$json,
  '.pb.UpdateAppLineConfigResp': UpdateAppLineConfigResp$json,
  '.pb.LoginMSCaptchaReq': LoginMSCaptchaReq$json,
  '.pb.LoginMSCaptchaResp': LoginMSCaptchaResp$json,
  '.pb.VerifyLoginMSCaptchaCodeReq': VerifyLoginMSCaptchaCodeReq$json,
  '.pb.VerifyLoginMSCaptchaCodeResp': VerifyLoginMSCaptchaCodeResp$json,
  '.pb.LoginMSReq': LoginMSReq$json,
  '.pb.LoginMSResp': LoginMSResp$json,
  '.pb.HealthMSResp': HealthMSResp$json,
  '.pb.ConfigMSResp': ConfigMSResp$json,
  '.pb.MStr': $0.MStr$json,
  '.pb.MStr.MEntry': $0.MStr_MEntry$json,
  '.pb.GetAllMSMenuListReq': GetAllMSMenuListReq$json,
  '.pb.Page': $0.Page$json,
  '.pb.GetAllMSMenuListReq.FilterEntry': GetAllMSMenuListReq_FilterEntry$json,
  '.pb.GetAllMSMenuListResp': GetAllMSMenuListResp$json,
  '.pb.MSMenu': MSMenu$json,
  '.pb.GetMyMSMenuListReq': GetMyMSMenuListReq$json,
  '.pb.GetMyMSMenuListResp': GetMyMSMenuListResp$json,
  '.pb.GetMSMenuDetailReq': GetMSMenuDetailReq$json,
  '.pb.GetMSMenuDetailResp': GetMSMenuDetailResp$json,
  '.pb.AddMSMenuReq': AddMSMenuReq$json,
  '.pb.AddMSMenuResp': AddMSMenuResp$json,
  '.pb.UpdateMSMenuReq': UpdateMSMenuReq$json,
  '.pb.UpdateMSMenuResp': UpdateMSMenuResp$json,
  '.pb.DeleteMSMenuReq': DeleteMSMenuReq$json,
  '.pb.DeleteMSMenuResp': DeleteMSMenuResp$json,
  '.pb.GetAllMSApiPathListReq': GetAllMSApiPathListReq$json,
  '.pb.GetAllMSApiPathListReq.FilterEntry': GetAllMSApiPathListReq_FilterEntry$json,
  '.pb.GetAllMSApiPathListResp': GetAllMSApiPathListResp$json,
  '.pb.MSApiPath': MSApiPath$json,
  '.pb.GetMyMSApiPathListReq': GetMyMSApiPathListReq$json,
  '.pb.GetMyMSApiPathListResp': GetMyMSApiPathListResp$json,
  '.pb.GetMSApiPathDetailReq': GetMSApiPathDetailReq$json,
  '.pb.GetMSApiPathDetailResp': GetMSApiPathDetailResp$json,
  '.pb.AddMSApiPathReq': AddMSApiPathReq$json,
  '.pb.AddMSApiPathResp': AddMSApiPathResp$json,
  '.pb.UpdateMSApiPathReq': UpdateMSApiPathReq$json,
  '.pb.UpdateMSApiPathResp': UpdateMSApiPathResp$json,
  '.pb.DeleteMSApiPathReq': DeleteMSApiPathReq$json,
  '.pb.DeleteMSApiPathResp': DeleteMSApiPathResp$json,
  '.pb.GetAllMSRoleListReq': GetAllMSRoleListReq$json,
  '.pb.GetAllMSRoleListReq.FilterEntry': GetAllMSRoleListReq_FilterEntry$json,
  '.pb.GetAllMSRoleListResp': GetAllMSRoleListResp$json,
  '.pb.MSRole': MSRole$json,
  '.pb.MSRole.ApiPathsEntry': MSRole_ApiPathsEntry$json,
  '.pb.MSRole.MenusEntry': MSRole_MenusEntry$json,
  '.pb.GetMSRoleDetailReq': GetMSRoleDetailReq$json,
  '.pb.GetMSRoleDetailResp': GetMSRoleDetailResp$json,
  '.pb.AddMSRoleReq': AddMSRoleReq$json,
  '.pb.AddMSRoleResp': AddMSRoleResp$json,
  '.pb.UpdateMSRoleReq': UpdateMSRoleReq$json,
  '.pb.UpdateMSRoleResp': UpdateMSRoleResp$json,
  '.pb.DeleteMSRoleReq': DeleteMSRoleReq$json,
  '.pb.DeleteMSRoleResp': DeleteMSRoleResp$json,
  '.pb.GetAllMSUserListReq': GetAllMSUserListReq$json,
  '.pb.GetAllMSUserListReq.FilterEntry': GetAllMSUserListReq_FilterEntry$json,
  '.pb.GetAllMSUserListResp': GetAllMSUserListResp$json,
  '.pb.MSUser': MSUser$json,
  '.pb.GetMSUserDetailReq': GetMSUserDetailReq$json,
  '.pb.GetMSUserDetailResp': GetMSUserDetailResp$json,
  '.pb.GetSelfMSUserDetailReq': GetSelfMSUserDetailReq$json,
  '.pb.GetSelfMSUserDetailResp': GetSelfMSUserDetailResp$json,
  '.pb.AddMSUserReq': AddMSUserReq$json,
  '.pb.AddMSUserResp': AddMSUserResp$json,
  '.pb.UpdateMSUserReq': UpdateMSUserReq$json,
  '.pb.UpdateMSUserResp': UpdateMSUserResp$json,
  '.pb.DeleteMSUserReq': DeleteMSUserReq$json,
  '.pb.DeleteMSUserResp': DeleteMSUserResp$json,
  '.pb.SwitchMSUserStatusReq': SwitchMSUserStatusReq$json,
  '.pb.SwitchMSUserStatusResp': SwitchMSUserStatusResp$json,
  '.pb.GetAllMSIpWhiteListReq': GetAllMSIpWhiteListReq$json,
  '.pb.GetAllMSIpWhiteListReq.FilterEntry': GetAllMSIpWhiteListReq_FilterEntry$json,
  '.pb.GetAllMSIpWhiteListResp': GetAllMSIpWhiteListResp$json,
  '.pb.MSIpWhiteList': MSIpWhiteList$json,
  '.pb.GetMSIpWhiteListDetailReq': GetMSIpWhiteListDetailReq$json,
  '.pb.GetMSIpWhiteListDetailResp': GetMSIpWhiteListDetailResp$json,
  '.pb.AddMSIpWhiteListReq': AddMSIpWhiteListReq$json,
  '.pb.AddMSIpWhiteListResp': AddMSIpWhiteListResp$json,
  '.pb.UpdateMSIpWhiteListReq': UpdateMSIpWhiteListReq$json,
  '.pb.UpdateMSIpWhiteListResp': UpdateMSIpWhiteListResp$json,
  '.pb.DeleteMSIpWhiteListReq': DeleteMSIpWhiteListReq$json,
  '.pb.DeleteMSIpWhiteListResp': DeleteMSIpWhiteListResp$json,
  '.pb.GetAllMSLuaConfigReq': GetAllMSLuaConfigReq$json,
  '.pb.GetAllMSLuaConfigReq.FilterEntry': GetAllMSLuaConfigReq_FilterEntry$json,
  '.pb.GetAllMSLuaConfigResp': GetAllMSLuaConfigResp$json,
  '.pb.LuaConfig': LuaConfig$json,
  '.pb.GetMSLuaConfigReq': GetMSLuaConfigReq$json,
  '.pb.GetMSLuaConfigResp': GetMSLuaConfigResp$json,
  '.pb.AddMSLuaConfigReq': AddMSLuaConfigReq$json,
  '.pb.AddMSLuaConfigResp': AddMSLuaConfigResp$json,
  '.pb.UpdateMSLuaConfigReq': UpdateMSLuaConfigReq$json,
  '.pb.UpdateMSLuaConfigResp': UpdateMSLuaConfigResp$json,
  '.pb.DeleteMSLuaConfigReq': DeleteMSLuaConfigReq$json,
  '.pb.DeleteMSLuaConfigResp': DeleteMSLuaConfigResp$json,
  '.pb.GetAllMSOperationLogReq': GetAllMSOperationLogReq$json,
  '.pb.GetAllMSOperationLogReq.FilterEntry': GetAllMSOperationLogReq_FilterEntry$json,
  '.pb.GetAllMSOperationLogResp': GetAllMSOperationLogResp$json,
  '.pb.MSOperationLog': MSOperationLog$json,
  '.pb.GetMSOperationLogDetailReq': GetMSOperationLogDetailReq$json,
  '.pb.GetMSOperationLogDetailResp': GetMSOperationLogDetailResp$json,
  '.pb.DeleteMSOperationLogReq': DeleteMSOperationLogReq$json,
  '.pb.DeleteMSOperationLogResp': DeleteMSOperationLogResp$json,
  '.pb.GetAllMSLoginRecordReq': GetAllMSLoginRecordReq$json,
  '.pb.GetAllMSLoginRecordReq.FilterEntry': GetAllMSLoginRecordReq_FilterEntry$json,
  '.pb.GetAllMSLoginRecordResp': GetAllMSLoginRecordResp$json,
  '.pb.MSLoginRecord': MSLoginRecord$json,
  '.pb.GetAllMSAlbumCateReq': GetAllMSAlbumCateReq$json,
  '.pb.GetAllMSAlbumCateResp': GetAllMSAlbumCateResp$json,
  '.pb.MSAlbumCate': MSAlbumCate$json,
  '.pb.DeleteMSAlbumCateReq': DeleteMSAlbumCateReq$json,
  '.pb.DeleteMSAlbumCateResp': DeleteMSAlbumCateResp$json,
  '.pb.AddMSAlbumCateReq': AddMSAlbumCateReq$json,
  '.pb.AddMSAlbumCateResp': AddMSAlbumCateResp$json,
  '.pb.UpdateMSAlbumCateReq': UpdateMSAlbumCateReq$json,
  '.pb.UpdateMSAlbumCateResp': UpdateMSAlbumCateResp$json,
  '.pb.GetAllMSAlbumReq': GetAllMSAlbumReq$json,
  '.pb.GetAllMSAlbumReq.FilterEntry': GetAllMSAlbumReq_FilterEntry$json,
  '.pb.GetAllMSAlbumResp': GetAllMSAlbumResp$json,
  '.pb.MSAlbum': MSAlbum$json,
  '.pb.DeleteMSAlbumReq': DeleteMSAlbumReq$json,
  '.pb.DeleteMSAlbumResp': DeleteMSAlbumResp$json,
  '.pb.UpdateMSAlbumReq': UpdateMSAlbumReq$json,
  '.pb.UpdateMSAlbumResp': UpdateMSAlbumResp$json,
  '.pb.StatsMSReq': StatsMSReq$json,
  '.pb.StatsMSResp': StatsMSResp$json,
  '.pb.StatsMSResp.Today': StatsMSResp_Today$json,
  '.pb.StatsMSResp.Series': StatsMSResp_Series$json,
  '.pb.ClearAllUserReq': ClearAllUserReq$json,
  '.pb.ClearAllUserResp': ClearAllUserResp$json,
};

/// Descriptor for `mgmtService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List mgmtServiceDescriptor = $convert.base64Decode('');
