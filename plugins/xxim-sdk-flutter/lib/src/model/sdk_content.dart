...
class RedPacketContent {
  ...
  String cover;
  int redPacketStatus;
  List<RedPacketReceiver> receiverList;
  int sendTime;
  int expireTime;
  ...
  RedPacketContent({
    ...
    required this.receiverList,
    required this.sendTime,
    required this.expireTime,
  });

  static RedPacketContent fromJson(String content) {
    Map<String, dynamic> map = json.decode(content);
    return RedPacketContent(
      redPacketId: map["redPacketId"],
      convId: map["convId"],
      title: map["title"],
      redPacketType: map["redPacketType"],
      count: map["count"],
      totalAmount: map["totalAmount"],
      singleAmount: map["singleAmount"],
      cover: map["cover"],
      redPacketStatus: map["redPacketStatus"],
      receiverList: (map["receiverList"] ?? [])
          .map((e) => RedPacketReceiver.fromJson(e))
          .toList()
          .cast<RedPacketReceiver>(),
...
class RedPacketReceiver {
  ...
  static RedPacketReceiver fromJson(Map<String, dynamic> map) {
    return RedPacketReceiver(
      userId: map["userId"],
      amount: map["amount"],
